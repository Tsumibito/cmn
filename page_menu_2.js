document.addEventListener('DOMContentLoaded', () => {
    ...
    // Store original colors of navbar lines
    ...
    /**
     * Sets up language buttons based on the current URL, with exceptions for specific homepages.
     */
    const setupLanguageButtons = () => {
        ...
        // Define exceptions for specific homepages
        const isFrenchHomepage = pathname === '';
        const isEnglishHomepage = pathname === '/en/home';

        // If current page is one of the homepages, do not alter the language buttons
        if (isFrenchHomepage || isEnglishHomepage) {
            console.log('Current page is a homepage. Language buttons are not modified.');
            return;
        }
    ...
    /**
     * Checks the age verification status from localStorage.
     */
    ...
    /**
     * Hides the age verification modal with animation.
     */
    ...
    /**
     * Toggles the navbar menu open and closed with animations.
     */
    ...
    /**
     * Handles the confirmation of age verification.
     */
    ...
    /**
     * Prevents language buttons from being intercepted by global event handlers.
